...
function dropBox(){
  ...
  if(thisBox.data("test")){
    thisBox.css({"background": "url('web/img/wombat1.png')", "background-size":"contain", "background-position":"center"});
  } else {
    thisBox.css({"background": "url('web/img/grumpy.png')", "background-size":"contain"});
  }
